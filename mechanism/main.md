...
- **Механизмът** може да се преизползва многократно — веднъж написан, той знае как да се листват данни, без да го интересува дали листваме потребители, продукти или поръчки.
...
Всяко следващо листване ще бъде дефинирано по **същия начин** — същата структура, същите ключове, същите типове callback функции. Разликата ще бъде само в имената на параметрите и кода вътре в самите callbacks.
