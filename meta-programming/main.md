...
Здравейте днес ще ви запозная с една нова 
...
Представете се че всичко свързано с даден проект
...
спомагат за автоматизация и проследяване на взаимовръзки, в
създаването и развиването на проекта.

Идеята е софтуера да съществува, като описание и всичко друго около него
да се автоматизира, тоест описанието да е ядрото и центъра на софтуера.


За да не бъдем голословни нека продължим с нагледен и опростен пример за такъв обект:
...
---
По-горе споменах многократно ключовата дума "**взаимовръзки**": 
Макар моя пример да изглежда малък и реторичен, описването
на структурата и взаимовръзките е от изключително значение 
за избягването на конфликти, сплитане и бъгове ... 
